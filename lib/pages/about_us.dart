    ...
    return SafeArea(top: false, bottom: false,
      child: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            Container(
              alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(0, 20, 0, 10),
              child: const Image(image: AssetImage('assets/icon.png'), height: 50,),),
            Container(alignment: Alignment.center, padding: const EdgeInsets.fromLTRB(0, 10, 0, 20),
              child: const Text("Version 1.0.0 \n www.tv360nigeria.com \n TV360 Nigeria App for ios and Android",
                textAlign: TextAlign.center, style: TextStyle(height: 1.6, color: Colors.black87),),
            ),
            const Divider(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const FavouriteArticles(),),);
                      },
                      child: ListTile(visualDensity: VisualDensity(vertical: -3),
                        ...
                        //   width: 30,
                        // ),
                        title: const Text('Favourite'), subtitle: const Text("See the saved news article"),
                      ),
                    ),
                    ...
                    InkWell(
                      onTap: () {
                        Share.share('Check out our app on Adnroid & ios: https://www.tv360nigeria.com');
                      },
                      child: ListTile(visualDensity: VisualDensity(vertical: -3),
